...
/* ========= 颜色预设 - 参考 style.css 配色 ========= */
const PRESETS = {
  // 蓝色系 (Blue) - 参考 --container-blue
  blue: {
    light: {
      bg: "linear-gradient(135deg, #f8fbff 0%, #e3f2fd 100%)",
      bgSolid: "#e3f2fd",
      border: "#90caf9",
      borderHover: "#64b5f6",
      accent: "#1e88e5",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #bbdefb 0%, #90caf9 100%)",
      shadow: "rgba(30,136,229,.12)",
      shadowHover: "rgba(30,136,229,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(227,242,253,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #0f172a 0%, #20303d 100%)",
      bgSolid: "#20303d",
      border: "#1565c0",
      borderHover: "#1e88e5",
      accent: "#64b5f6",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #0d47a1 0%, #1565c0 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(100,181,246,.25)",
      cardBg: "rgba(30,41,59,0.6)",
      rowBg: "rgba(15,23,42,0.5)",
    },
  },
  // 绿色系 (Green) - 参考 --container-green
  green: {
    light: {
      bg: "linear-gradient(135deg, #f5fff8 0%, #e8f5e9 100%)",
      bgSolid: "#e8f5e9",
      border: "#a5d6a7",
      borderHover: "#81c784",
      accent: "#43a047",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #c8e6c9 0%, #a5d6a7 100%)",
      shadow: "rgba(67,160,71,.12)",
      shadowHover: "rgba(67,160,71,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(232,245,233,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #0a200a 0%, #203d20 100%)",
      bgSolid: "#1a3a1a",
      border: "#2e7d32",
      borderHover: "#43a047",
      accent: "#81c784",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #1b5e20 0%, #2e7d32 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(129,199,132,.2)",
      cardBg: "rgba(32,61,32,0.5)",
      rowBg: "rgba(10,32,10,0.5)",
    },
  },
  // 橙色系 (Orange) - 参考 --container-orange
  orange: {
    light: {
      bg: "linear-gradient(135deg, #fffaf5 0%, #fff3e0 100%)",
      bgSolid: "#fff3e0",
      border: "#ffcc80",
      borderHover: "#ffb74d",
      accent: "#fb8c00",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #ffe0b2 0%, #ffcc80 100%)",
      shadow: "rgba(251,140,0,.12)",
      shadowHover: "rgba(251,140,0,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(255,243,224,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #1a0f05 0%, #3d3020 100%)",
      bgSolid: "#27170a",
      border: "#e65100",
      borderHover: "#fb8c00",
      accent: "#ffb74d",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #bf360c 0%, #e65100 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(255,183,77,.2)",
      cardBg: "rgba(61,48,32,0.5)",
      rowBg: "rgba(26,15,5,0.5)",
    },
  },
  // 紫色系 (Purple) - 参考 --container-purple
  purple: {
    light: {
      bg: "linear-gradient(135deg, #faf5ff 0%, #f3e5f5 100%)",
      bgSolid: "#f3e5f5",
      border: "#ce93d8",
      borderHover: "#ba68c8",
      accent: "#8e24aa",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #e1bee7 0%, #ce93d8 100%)",
      shadow: "rgba(142,36,170,.12)",
      shadowHover: "rgba(142,36,170,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(243,229,245,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #1a0a2e 0%, #302030 100%)",
      bgSolid: "#251530",
      border: "#7b1fa2",
      borderHover: "#8e24aa",
      accent: "#ba68c8",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #4a148c 0%, #6a1b9a 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(186,104,200,.2)",
      cardBg: "rgba(48,32,48,0.5)",
      rowBg: "rgba(26,10,46,0.5)",
    },
  },
  // 粉色系 (Pink) - 参考 --container-pink
  pink: {
    light: {
      bg: "linear-gradient(135deg, #fff5f8 0%, #fce4ec 100%)",
      bgSolid: "#fce4ec",
      border: "#f48fb1",
      borderHover: "#f06292",
      accent: "#d81b60",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #f8bbd9 0%, #f48fb1 100%)",
      shadow: "rgba(216,27,96,.12)",
      shadowHover: "rgba(216,27,96,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(252,228,236,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #2a0a18 0%, #3d2030 100%)",
      bgSolid: "#350c1e",
      border: "#c2185b",
      borderHover: "#d81b60",
      accent: "#f06292",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #880e4f 0%, #ad1457 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(240,98,146,.2)",
      cardBg: "rgba(61,32,48,0.5)",
      rowBg: "rgba(42,10,24,0.5)",
    },
  },
  // 黄色系 (Yellow) - 参考 --container-yellow
  yellow: {
    light: {
      bg: "linear-gradient(135deg, #fffef5 0%, #fffde7 100%)",
      bgSolid: "#fffde7",
      border: "#fff59d",
      borderHover: "#fff176",
      accent: "#fdd835",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #fff9c4 0%, #fff59d 100%)",
      shadow: "rgba(253,216,53,.12)",
      shadowHover: "rgba(253,216,53,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(255,253,231,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #1c1305 0%, #3d3a20 100%)",
      bgSolid: "#27190a",
      border: "#f9a825",
      borderHover: "#fbc02d",
      accent: "#fff176",
      accentLight: "#fff59d",
      text: "#fff9c4",
      textSecondary: "#fff59d",
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #f57f17 0%, #f9a825 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(255,241,118,.2)",
      cardBg: "rgba(61,58,32,0.5)",
      rowBg: "rgba(28,19,5,0.5)",
    },
  },
  // ========= 参考 style.css 新增配色 =========
  // 青色系 (Cyan) - 对应 --container-cyan
  cyan: {
    light: {
      bg: "linear-gradient(135deg, #f0fdfa 0%, #e0f7fa 100%)",
      bgSolid: "#e0f7fa",
      border: "#80deea",
      borderHover: "#4dd0e1",
      accent: "#00acc1",
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #b2ebf2 0%, #80deea 100%)",
      shadow: "rgba(0,172,193,.12)",
      shadowHover: "rgba(0,172,193,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(224,247,250,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #0a2628 0%, #203035 100%)",
      bgSolid: "#0f2d30",
      border: "#00838f",
      borderHover: "#00acc1",
      accent: "#4dd0e1",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #004d40 0%, #00695c 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(77,208,225,.2)",
      cardBg: "rgba(32,48,53,0.5)",
      rowBg: "rgba(10,38,40,0.5)",
    },
  },
  // 灰色系 (Gray) - 对应 --container-gray
  gray: {
    light: {
      bg: "linear-gradient(135deg, #f8f9fa 0%, #eceff1 100%)",
      bgSolid: "#eceff1",
      border: "#b0bec5",
      borderHover: "#90a4ae",
      accent: "#546e7a",
      ...
      muted: "#607d8b",
      iconBg: "linear-gradient(135deg, #cfd8dc 0%, #b0bec5 100%)",
      shadow: "rgba(84,110,122,.12)",
      shadowHover: "rgba(84,110,122,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(236,239,241,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #1a1f24 0%, #263238 100%)",
      bgSolid: "#1e272c",
      border: "#455a64",
      borderHover: "#546e7a",
      accent: "#90a4ae",
      ...
      muted: "#78909c",
      iconBg: "linear-gradient(135deg, #37474f 0%, #455a64 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(144,164,174,.2)",
      cardBg: "rgba(38,50,56,0.5)",
      rowBg: "rgba(26,31,36,0.5)",
    },
  },
  // 红色系 (Red) - 对应 --container-red
  red: {
    light: {
      ...
      muted: "#64748b",
      iconBg: "linear-gradient(135deg, #ffcdd2 0%, #ef9a9a 100%)",
      shadow: "rgba(229,57,53,.12)",
      shadowHover: "rgba(229,57,53,.22)",
      cardBg: "rgba(255,255,255,0.7)",
      rowBg: "rgba(255,235,238,0.8)",
    },
    dark: {
      bg: "linear-gradient(135deg, #2a1010 0%, #3d2020 100%)",
      bgSolid: "#2d1515",
      border: "#c62828",
      borderHover: "#e53935",
      accent: "#ef5350",
      ...
      muted: "#94a3b8",
      iconBg: "linear-gradient(135deg, #b71c1c 0%, #c62828 100%)",
      shadow: "rgba(0,0,0,.3)",
      shadowHover: "rgba(239,83,80,.2)",
      cardBg: "rgba(61,32,32,0.5)",
      rowBg: "rgba(42,16,16,0.5)",
    },
  },
};
